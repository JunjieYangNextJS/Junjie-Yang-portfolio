...
const items = [
  {
    ...
    desc: "This app is built with industry standard technologies featuring React, Nodejs, Express, Mongodb, Amazon S3, react-redux, RTK query, websockets, JWT authentication flow, REST apis and etc.",
  },
  {
    id: 2,
